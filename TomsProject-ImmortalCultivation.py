...
MEDITATION_EVENTS = [
    ...
    {
        "title": "The Crooked Step",
        "text": "Daoist Dawlark asks you to walk across the courtyard without stepping on any cracks. The bizarre lesson smooths your Qi flow and patience.",
        "qi": 12,
        "health": 5,
        "locations": ["Sect Courtyard"],
...
# --- SECT GROUNDS: REGULAR EVENTS (Realms 0 - 3) ---
    ...
    {
        "title": "High-Grade Procurement",
        "text": "With 20 coins as a guarantee, the Alchemist lets you into the back room. You purchase a rare artifact that hums with protective energy.",
        "qi": 5,
        "health": 5,
        "wealth": -15,
        "add_items": ["Coyote's Favor"],
        "min_wealth": 20,
        "locations": ["Sect Market"],
        "weight": 40
    },
